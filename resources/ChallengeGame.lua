...
ChallengeGame.enableLimitedInventory = false
ChallengeGame.enableRestrictions = false
...
function ChallengeGame.server_loadLevel( self, loadJsonData, loadSaveData )
	sm.log.info( "Loading level: "..tostring( self:server_getLevelUuid() ) )
	...
	if self.build and not self.build.testing then
		worldScriptFilename = "$CHALLENGE_DATA/Scripts/challenge/BuilderWorld.lua"
		worldScriptClass = "BuilderWorld"
	else
		worldScriptFilename = "$CHALLENGE_DATA/Scripts/challenge/ChallengeWorld.lua"
